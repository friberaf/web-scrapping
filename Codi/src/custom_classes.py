...
class Team:
	...
	"""
	Ordre del header:
	season,name,position,points,played,won,drawn,lost,gf,ga,gd,h_points,
	h_played,h_won,h_drawn,h_lost,h_gf,h_ga,h_gd,a_points,a_played,a_won,
	a_drawn,a_lost,a_gf,a_ga,a_gd
	"""
	def export(self):
		team_list = list()
		team_list.extend((
...
class Match:
	def __init__(self, season, matchweek, home, away, result):
		self.season = season
